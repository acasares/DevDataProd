...
Originally, this problem asked which was the distance to the fourth vertix. Let's answer this question first. See next a plot of the problem, taken the original data: AX = 3, BX = 12, CX = 11. X is an interior point, such that its distances agree with the data. DX is the unknown distance.     
